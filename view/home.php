...
<div class="banner">
    <img src="../view/images/poster1.png" alt="">
</div>
<div class="product">
                            ...
                            <form method="POST" action="../controller/index.php?act=cart">
                                <nav style="background: #fff"; margin: "2rem";>
                                    ...
                                    <div class="content">   
                                        ...
                                        <p>' . $row['gia'] . ' VNĐ</p>
                                        <input type="hidden" name="id_sanpham" value="' . $row['id'] . '"/> <!-- ID sản phẩm -->
                        ...
                        <div class="sanpham1">
                            <form method="POST" action="../controller/index.php?act=cart">
                                <nav style="background: #fff"; margin: "2rem";>
                                    ...
                                    <h3 class="tensp" style="width: 70%; font-weight: 500; margin-left: 2rem;">' . substr($row['tensp'], 0, 45) . '</h3>
                                    <p>' . $row['gia'] . ' VNĐ</p>
                                    <input type="hidden" name="id_sanpham" value="' . $row['id'] . '"/> <!-- ID sản phẩm -->
                                    <input type="hidden" name="hinh" value="' . $row['hinh'] . '"/>
                                    <input type="hidden" name="tensp" value="' . $row['tensp'] . '"/>
